	...
	<header>
		<div class="container nav">
			...
			<ul class="menu">
				...
				<li><a href="${pageContext.request.contextPath}/hot-products">Sản
						phẩm</a>
					<div class="dropdown">
			...
			<div class="icons">
				<a
					href="${pageContext.request.contextPath}/wishlist-controller?action=view"
					class="wishlist-link"> <i class="fa fa-heart"></i>
				</a> <a
					href="${pageContext.request.contextPath}/cart-controller?action=view"
							...
							<div class="notify-list">
								<c:forEach items="${listNotify}" var="n">
									<div class="notify-item ${n.isRead ? '' : 'unread'}"
										...
										<small><fmt:formatDate value="${n.createdAt}"
												pattern="HH:mm dd/MM/yyyy" /></small>
									</div>
								</c:forEach>
								<c:if test="${empty listNotify}">
									<div class="p-3 text-center text-muted"
										style="font-size: 12px;">Không có thông báo mới</div>
								</c:if>
							</div>
						</div>
					</div>
